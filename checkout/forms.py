...
class OrderForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """autofocus attribute on the full name field to true so the cursor
            will start in the full name field when the user loads the page
        """
        ...
        for field in self.fields:
            ...
            # 'stripe-style-input' styling in our checkout/static/checkout.css
